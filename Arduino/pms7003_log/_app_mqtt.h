...
//sensor
unsigned long SENSOR_INTERVAL = 10; //seconds
...
void publishSensor() {
  ...
  jPayload["PM_RAW_0.5"] = data.PM_RAW_0_5;
  jPayload["PM_RAW_1.0"] = data.PM_RAW_1_0;
